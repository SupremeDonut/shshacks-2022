...
function Land() {
	...
	<div className="land page" id="land">
		...
		<h1>Why global warming is deadly throughout people
</h1>
			<p> Heat waves caused by global warming present greater risk of heat-related illness and death, most frequently among people who have diabetes who are elderly or are very young.

</p>
		</div>
		<div className="subsection deforestation">
		<h1> Rainforest destruction is a major cause of carbon dioxide release
</h1>
			<p>When they are degraded or completely cleared, e.g. by fire - a process referred to as deforestation - this stored carbon has the potential to be released back into the atmosphere as carbon dioxide and contribute to climate change.
</p>
		</div>
